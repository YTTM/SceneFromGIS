...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_left.addWidget(self.pushButton_remove_layer, 2, 0, 1, 1)
        self.listWidget_input = QtWidgets.QListWidget(self.centralwidget)
        self.listWidget_input.setObjectName("listWidget_input")
        self.gridLayout_left.addWidget(self.listWidget_input, 1, 0, 1, 1)
        ...
        self.gridLayout_left.addLayout(self.gridLayout_properties, 3, 0, 1, 1)
        ...
        self.gridLayout_left.addLayout(self.gridLayout_project_setup, 0, 0, 1, 1)

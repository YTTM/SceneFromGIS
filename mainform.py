...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox_1.setItemText(0, _translate("MainWindow", "heightmap"))
        self.comboBox_1.setItemText(1, _translate("MainWindow", "path (line)"))
        self.comboBox_1.setItemText(2, _translate("MainWindow", "building (line)"))
        self.comboBox_1.setItemText(3, _translate("MainWindow", "building (polygon)"))
        self.comboBox_1.setItemText(4, _translate("MainWindow", "forest (line)"))
        self.comboBox_1.setItemText(5, _translate("MainWindow", "forest (polygon)"))
        self.comboBox_1.setItemText(6, _translate("MainWindow", "forest (point)"))
        self.comboBox_1.setItemText(7, _translate("MainWindow", "water (line)"))
        self.comboBox_1.setItemText(8, _translate("MainWindow", "water (polygon)"))
